...
function insert(req, res) {
  ...
  baseRepo
    .insert(ep, params)
    .then((response) => sendResponse(res, response, constants.HTTP_STATUS_CODES.CREATED))
    .catch((err) => sendError(res, err, constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR));
}
